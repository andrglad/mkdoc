...
<img alt="Рисунок 219" height="499" src="/img/UG_files/image82.png" width="30%"/>
...
Автоматически созданное описание" height="550" src="/img/UG_files/image83.png" width="100%"/>
...
<img alt="Изображение выглядит как текст, компьютер, снимок экрана, ноутбук
Автоматически созданное описание" src="/img/UG_files/image84.png"/>
``
</p>
```
``
...
<img alt="Рисунок 51" height="893" src="/img/UG_files/image86.png" width="100%"/>
...
Автоматически созданное описание" src="/img/UG_files/image87.png"/>
...
Автоматически созданное описание" height="168" src="/img/UG_files/image88.png" width="50%"/>
...
<img alt="Рисунок 37" height="439" src="/img/UG_files/image89.png" style="cursor: nwse-resize;" width="100%"/>
``
</p>
```
``
