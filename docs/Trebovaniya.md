...
<img alt="Рисунок 87" height="710" src="/img/UG_files/image92.png" width="100%" />
...
значок
«`<img alt="Picture 8" height="14.4" src="/img/UG_files/image93.png" width="12.9" />».
<img alt="Изображение выглядит как текст
Автоматически созданное описание" height="246" src="/img/UG_files/image94.png" width="60%" />
Нажмите левой кнопкой мышки на значок
«`<img alt="Picture 15" height="14.4" src="/img/UG_files/image95.png" width="12.9" />»
и выберите из выпадающего меню пункт
**Редактировать** для изменения названия
стандарта или пункт **Удалить** для его
удаления.
<img alt="Рисунок 98" height="315" src="/img/UG_files/image96.png" width="60%" />
...
**Сохранить**.
<img alt="Изображение выглядит как текст
Автоматически созданное описание" height="215" src="/img/UG_files/image97.png" width="60%" />
...
**Сохранить**.
<img alt="Рисунок 100" height="346" src="/img/UG_files/image98.png" width="60%" />
...
«`<img alt="Picture 59" height="14.4" src="/img/UG_files/image99.png" width="12.9" />».
Нажмите левой кнопкой мышки на значок
«`<img alt="Picture 60" height="14.4" src="/img/UG_files/image100.png" width="12.9" />»
и выберите из выпадающего меню пункт
**Редактировать** для изменения названия
категории или пункт **Удалить** для её
удаления.
<img alt="Рисунок 103" height="391" src="/img/UG_files/image101.png" width="60%" />
Для изменения названия категории выберите пункт выпадающего меню
**Редактировать**, скорректируйте
название категории в поле ввода и нажмите кнопку
**Сохранить**.
<img alt="Изображение выглядит как текст
Автоматически созданное описание" height="320" src="/img/UG_files/image102.png" width="60%" />
...
значок
«`<img alt="Picture 92" height="14.4" src="/img/UG_files/image103.png" width="12.9" />».
Нажмите левой кнопкой мышки на значок
«`<img alt="Picture 93" height="14.4" src="/img/UG_files/image104.png" width="12.9" />»
и выберите из выпадающего меню пункт
**Редактировать** для изменения названия
требования или пункт **Удалить** для его
удаления.
<img alt="Изображение выглядит как текст
Автоматически созданное описание" height="410" src="/img/UG_files/image105.png" width="60%" />
Для изменения названия требования выберите пункт выпадающего меню
**Редактировать**, скорректируйте
название требования в поле ввода и нажмите кнопку
**Сохранить**.
<img alt="Изображение выглядит как текст
Автоматически созданное описание" height="324" src="/img/UG_files/image106.png" width="60%" />
``
</p>
```
``
...
системе.
<img alt="Рисунок 89" height="298" src="/img/UG_files/image107.png" width="60%" />
``
</p>
```
``
...
<img alt="Рисунок 91" height="412" src="/img/UG_files/image108.png" width="100%" />
...
Автоматически созданное описание" height="777" src="/img/UG_files/image109.png" width="50%" />
``
</p>
```
``
