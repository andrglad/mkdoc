...
Автоматически созданное описание" height="13.1" src="/img/UG_files/image47.png" width="18.9" />.
...
Автоматически созданное описание" src="/img/UG_files/image48.png" style="cursor: nwse-resize;" />
``
<p class="a0">
```
...
Автоматически созданное описание" height="15.1" src="/img/UG_files/image49.png" width="16.0" />.
...
`<img alt="Изображение выглядит как текст, снимок экрана, внутренний, компьютер
Автоматически созданное описание" src="/img/UG_files/image51.png" />
``
</p>
```
``
...
приложении.
`<img alt="Рисунок 114" src="/img/UG_files/image52.png" />
...
<li class="a0">
```
«`<img alt="Picture 151" height="17.6" src="/img/UG_files/image54.png" width="16.2" />»
--- критичный;
«`<img alt="Picture 152" height="17.5" src="/img/UG_files/image55.png" width="15.5" />»
--- высокий;
«`<img alt="Picture 153" height="18.3" src="/img/UG_files/image56.png" width="15.5" />»
--- средний;
«`<img alt="Picture 154" height="17.6" src="/img/UG_files/image57.png" width="15.5" />»
--- низкий;
«`<img alt="Picture 155" height="17.5" src="/img/UG_files/image58.png" width="15.5" />»
--- инфо.
``
</li>
```
...
```
    ...
    <li class="a0">Статус дефекта:
      <ul>
        <li class="a0">«<img alt="Picture 159" height="16.2" src="/img/UG_files/image59.png" width="16.2" />» — подтвержден;</li>
        <li class="a0">«<img alt="Picture 160" height="16.1" src="/img/UG_files/image60.png" width="16.8" />» — ложное срабатывание;</li>
        <li class="a0">«<img alt="Picture 161" height="16.9" src="/img/UG_files/image61.png" width="16.9" />» — не обработан.</li>
      </ul>
    </li>
...
Автоматически созданное описание" src="/img/UG_files/image65.png" />
...
«`<img alt="Picture 21" height="12.4" src="/img/UG_files/image69.png" width="13.9" />»,
...
«`<img alt="Picture 23" height="11.4" src="/img/UG_files/image70.png" width="14.3" />».
...
«`<img alt="Рисунок 56" height="15.3" src="/img/UG_files/image71.png" width="15.3" />»,
...
<img alt="Рисунок 11" src="/img/UG_files/image73.gif" style="cursor: nwse-resize;" />
``
</p>
```
``
